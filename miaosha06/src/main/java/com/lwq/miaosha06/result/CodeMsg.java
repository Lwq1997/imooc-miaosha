...
public class CodeMsg {
    ...
    public static CodeMsg NOT_ACCESS = new CodeMsg(500102, "访问太频繁");
     //登录模块 5002XX
    ...
    public static CodeMsg REQUEST_ILLEGAL = new CodeMsg(500502,"路径不合法");
    public static CodeMsg MIAOSHA_FAIL = new CodeMsg(500503,"服务器故障");
    public static CodeMsg VERIFY_CODE_ERROR = new CodeMsg(50050,"验证码错误");
