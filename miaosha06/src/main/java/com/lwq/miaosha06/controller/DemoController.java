...
public class DemoController {
    ...
    @RequestMapping("/mq_topic_send")
    @ResponseBody
    public String mq_topic(){
        mqSender.sendTopic("hello mq_topic");
        return "hello lwq";
    }

    @RequestMapping("/mq_fanout_send")
    @ResponseBody
    public String mq_fanout(){
        mqSender.sendFanout("hello mq_fanout");
        return "hello lwq";
    }

    @RequestMapping("/mq_header_send")
    @ResponseBody
    public String mq_header(){
        mqSender.sendHeader("hello mq_header");
        return "hello lwq";
    }
